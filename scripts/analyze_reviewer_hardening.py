"""Reviewer-facing inference, vacuity, and ceiling-robust diagnostics."""
...
def main():
    ...
    out = RESULTS / "reviewer_hardening_analysis.json"
    out.write_text(json.dumps(result, indent=2) + "\n")

    lines = [
        "# Reviewer Hardening Analysis",
        "",
    ...
    report = RESULTS / "reviewer_hardening_analysis.md"
    report.write_text("\n".join(lines) + "\n")
