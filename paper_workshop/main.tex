...
\caption{Question-answering use case. For the same context and question, a spectrum-preserving swap (SPS) moves the
maximum attention weight from a distractor (``Paris'') to required evidence (``Tokyo''). The model, values,
