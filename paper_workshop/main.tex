...
Fixed-Spectrum Swaps Separate Capacity from Assignment}
...
without corresponding routing changes. Fixed-spectrum swaps give a controlled test of whether attention
...
We test this with a fixed-spectrum intervention. At the answer query, we exchange the weight on a known source
...
\caption{Question-answering use case. For the same context and question, a fixed-spectrum swap moves the
...
to the exact fixed-spectrum swap vector in Equation~\ref{eq:residual-change}.
...
Fixed-spectrum swaps identify the causal effect of a specified attention reassignment, not a complete account
