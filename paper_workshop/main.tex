...
without corresponding routing changes. FSS gives a controlled test of whether attention
...
We test this with a fixed-spectrum swap (FSS). At the answer query, we exchange the weight on a known
...
The protocol has a narrower interpretation. At a fixed context, a fixed-spectrum swap measures whether a
...
FSS identifies the causal effect of a specified attention reassignment, not a complete account
